...
export function LecturerAttendance() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-gray-900">Presensi Mahasiswa</h1>
        <p className="text-gray-600 mt-1">Kelola dan pantau kehadiran mahasiswa</p>
      </div>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {studentAttendance.map((student, index) => (
                      <tr key={student.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-900">{student.nim}</td>
